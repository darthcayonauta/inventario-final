...
private function actualizaUserData()
{
                                        ...
                                        $_POST['id_usuario']))
  {
	 ...
	 $descripcionEvento = "Usuario {$_POST['login']} actualizado";
...
*/
																		 ...
																		 addslashes( $_POST['clave'] ) ))
	{
		...
		//agregar en registro de acciones de usuario
		 $descripcionEvento = "Usuario {$_POST['login']} Ingresado al Sistema";
...
private function cambiaEstadoUsuario()
{
    ...
    if( $estado == 1 )
    {
        ...
        if( $cambia )
            {
							//agregar en registro de acciones de usuario
						$descripcionEvento = "Usuario {$login} Inhabilitado";
